...
During 2019A our remote transient detection pipeline was developed and deployed under our FDST collaboration LT programme PL19A13. We successfully classified 4 remote transients (2$\times$SN Ia, 1$\times$SN II, and 1$\times$SN Ia-91bg). We requested observations for a further 4 remote objects but classification data was not taken. We abandoned these objects after their light curves began to decline due to the limited scientific value of an object without rise information or a peak spectrum, and to preserve time for future targets. We believe our Grade B status had a detrimental affect on our ability to rapidly classify our desired transients, and, therefore, to maximise the scientific return we request Grade A time.
